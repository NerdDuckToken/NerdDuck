...
- Telegramgroup : t.me/Nerd_Duck
- Twitter : twitter.com/NerdDuck_Token
- Website : NerdDuck.com
...
contract NerdDuck is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    // Burn address
    address public constant TEAM_ADDRESS =
        0x0F2aB311C94A34880d3470fE7f1df834e55f6d13;
    ...
    uint256 private _tTotal = 3000 * 10**9 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "NerdDuck";
    string private _symbol = "NerdD";
    ...
    uint256 public _maxTxAmount = 3000 * 10**9 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 3000 * 10**9 * 10**18;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            require(
                ...
                "NerdD::transfer: Mkt value invalid"
            );
